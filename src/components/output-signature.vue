      ...
      <section>
        ...
        <tr>
            ...
            "background: none; border-width: 0px; border: 0px; margin: 0; padding: 0;">
              <tr>
                  <td colspan="2" style=
                  "padding-bottom: 5px; color: #0F2846; font-size: 18px; font-family: Arial, Helvetica, sans-serif;">
                  {{fullName}}
                  </td>
                </tr>
                <tr>
              ...
              <div v-show="!mobilePhoneSwitch">
                ...
                <tr>
                  ...
                  "vertical-align: top; width: 20px; color: #0F2846; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  Direct:
                  </td>
                  <td valign="top" style=
